...
namespace YariazenCore
{
    internal class CreativeTerminal : CustomAppliance
	{
        ...
        {
            MaterialUtils.ApplyMaterial(appliance.Prefab, "OrderMachine/Base_L_Counter.blend", new Material[] { MaterialUtils.GetExistingMaterial("Wood - Default"), MaterialUtils.GetExistingMaterial("Wood 4 - Painted"), MaterialUtils.GetExistingMaterial("Wood 4 - Painted") });
            MaterialUtils.ApplyMaterial(appliance.Prefab, "OrderMachine/Base_L_Counter.blend/Handle_L_Counter.blend", new Material[] { MaterialUtils.GetExistingMaterial("Knob") });
            MaterialUtils.ApplyMaterial(appliance.Prefab, "OrderMachine/Top_L_Counter.blend", new Material[] { MaterialUtils.GetExistingMaterial("Wood - Default") });
            MaterialUtils.ApplyMaterial(appliance.Prefab, "OrderMachine/Cube", new Material[] { MaterialUtils.GetExistingMaterial("Plastic - Black"), MaterialUtils.GetExistingMaterial("Screen") });
